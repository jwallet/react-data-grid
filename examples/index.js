...
import CustomHeaders from "./demos/example33-custom-headers";
...
ReactDOM.render(
  <StrictMode>
    <HashRouter>
      <ul className="nav">
        <li>
          <NavLink to="/examples/basic">Basic Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/resizable-cols">
            Resizable Cols Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/frozen-cols">Frozen Cols Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/editable">Editable Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/custom-formatters">
            Custom Formatters Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/built-in-editors">
            Built In Editors Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/sortable-cols">Sortable Cols Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/filterable-grid">
            Filterable Grid Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/immutable-data">
            Immutable Data Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/customRowRenderer">
            Custom Row Renderer Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/all-features">All Features Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/all-features-immutable">
            All Features Immutable Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/empty-rows">Empty Rows Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/cell-drag-down">
            Cell Drag Down Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/filterable-sortable-grid">
            Filterable Sortable Grid Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/row-select">Row Select Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/grid-events">Grid Events Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/context-menu">Context Menu Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/column-events">Column Events Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/cell-navigation">
            Cell Navigation Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/cell-selection-events">
            Cell Selection Events
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/grouping">Grouping Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/custom-filters">
            Custom Filters Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/immutable-data-grouping">
            Immutable Data Grouping Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/draggable-header">
            Draggable Header Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/tree-view">Tree View Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/tree-view-no-add-delete">
            Tree View No Add Delete Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/cell-actions">Cell Actions Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/scroll-to-row-index">
            Scroll To Row Index Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/descendingFirstSortable">
            Descending First Sortable Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/selection-range-events">
            Selection Range Events Example
          </NavLink>
        </li>
        <li>
          <NavLink to="/examples/isScrolling">IsScrolling Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/summary-rows">Summary Rows Example</NavLink>
        </li>
        <li>
          <NavLink to="/examples/custom-headers">
      ...
      <Route
        path="/examples/all-features-immutable"
        component={AllFeaturesImmutable}
      />
      <Route path="/examples/empty-rows" component={EmptyRows} />
      <Route path="/examples/cell-drag-down" component={CellDragDown} />
      <Route
        path="/examples/filterable-sortable-grid"
        component={FilterableSortableGrid}
      />
      ...
      <Route
        path="/examples/cell-selection-events"
        component={CellSelectionEvents}
      />
      <Route path="/examples/grouping" component={Grouping} />
      <Route path="/examples/custom-filters" component={CustomFilters} />
      <Route
        path="/examples/immutable-data-grouping"
        component={ImmutableDataGrouping}
      />
      <Route path="/examples/draggable-header" component={DraggableHeader} />
      <Route path="/examples/tree-view" component={TreeView} />
      <Route
        path="/examples/tree-view-no-add-delete"
        component={TreeViewNoAddDelete}
      />
      <Route path="/examples/cell-actions" component={CellActions} />
      <Route
        path="/examples/scroll-to-row-index"
        component={ScrollToRowIndex}
      />
      <Route
        path="/examples/descendingFirstSortable"
        component={DescendingFirstSortable}
      />
      <Route
        path="/examples/selection-range-events"
        component={SelectionRangeEvents}
      />
      <Route path="/examples/isScrolling" component={IsScrolling} />
      <Route path="/examples/summary-rows" component={SummaryRows} />
      <Route path="/examples/custom-headers" component={CustomHeaders} />
    </HashRouter>
  </StrictMode>,
